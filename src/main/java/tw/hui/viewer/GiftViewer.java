...
public class GiftViewer extends HttpServlet {
	...
	// private static final String TEMPLATE_PATH = "/WEB-INF/views/ok.html";
...
//			}
			...
			String tableHTML = readTableHTM(gifts);
			System.out.println(template);
			
			String html = template
						.replace("{{TITTLE}}", "Hui Big Company")
	...
	private String readTableHTM(List<Gift> gifts) {
